-- Fix RLS Policies and Add Indexes for Projects Performance (Safe Version)
...
-- ==============================================
-- PART 4: Add Indexes for Performance (Only if columns exist)
-- ==============================================
...
-- Products indexes - using DO blocks to check column existence
DO $$
BEGIN
