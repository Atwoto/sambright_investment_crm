    ...
    const mockInvoices: Invoice[] = [
      {
        ...
        status: 'paid',
        items: [
          { description: 'Acrylic Paint Set - Primary Colors', quantity: 2, price: 89.99, total: 179.98 },
          { description: 'Canvas Panel 16x20 inch', quantity: 3, price: 22.00, total: 66.01 }
        ]
      },
      {
        id: '2',
        ...
        status: 'pending',
        items: [
          { description: 'Oil Painting Brushes Set', quantity: 1, price: 75.50, total: 75.50 },
          { description: 'Palette Knife Set', quantity: 1, price: 50.00, total: 50.00 }
        ]
      },
      {
        id: '3',
        ...
        status: 'overdue',
        items: [
          { description: 'Watercolor Paper - Premium Grade', quantity: 1, price: 89.99, total: 89.99 }
        ]
      }
    ];
    ...
    try {
      ...
      const pdfContent = `
        ...
        ${invoice.items.map(item => 
          `${item.description} - Qty: ${item.quantity} - Price: $${item.price.toFixed(2)} - Total: $${item.total.toFixed(2)}`
        ).join('\n')}
              ...
              <CardContent className="space-y-4">
                  ...
                  <div className="mt-2 space-y-2">
                    {invoice.items.map((item, index) => (
                      <div key={index} className="flex justify-between items-center text-sm">
                        ...
                        <span className="text-muted-foreground mx-2">Qty: {item.quantity}</span>
                ...
                <div className="flex justify-end">
                  ...
                  >
                    ...
                    <span>
                      {generatingPDF === invoice.id ? 'Generating...' : 'Download Invoice'}
                    </span>
                  </Button>
                </div>
              </CardContent>
